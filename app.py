...
def price_predict():
    ...
    for feature in label_encoders:
        new_crop_data[feature] = label_encoders[feature].transform(new_crop_data[feature])

    # Predict prices
    predicted_price = price_model.predict(new_crop_data[['State', 'District', 'Market', 'Commodity']])

    if predicted_price.ndim == 1:
        modal_price = predicted_price[0]
        min_price = predicted_price[1]
        max_price = predicted_price[2]
    else:
